...
import banner from '../../../assest/WorldAdd.png'
                            ...
                            <div className={styles.homecontainer}>
                                <div>
                                    <div>
                                        ...
                                        {item.text && <p className={styles.headingtxtsty}>{item.text}</p>}
...
export default BrekingDetailsScreen;
